...
func TestDev(t *testing.T) {
	//assignTasks(servers []int, tasks []int)
	testCases := []struct {
		servers []int
		tasks   []int
		expect  []int
		...
		{
			[]int{10, 63, 95, 16, 85, 57, 83, 95, 6, 29, 71},
			[]int{70, 31, 83, 15, 32, 67, 98, 65, 56, 48, 38, 90, 5},
			[]int{8, 0, 3, 9, 5, 1, 10, 6, 4, 2, 7, 9, 0},
		},
		{
			[]int{74, 57, 61, 82, 67, 97, 67, 21, 61, 79, 21, 50, 14, 88, 48, 52, 76, 64},
			[]int{21, 100, 48, 64, 20, 8, 28, 10, 3, 63, 7},
			[]int{12, 7, 10, 14, 11, 15, 1, 2, 8, 17, 4},
		},
		{
	...
	for _, testCase := range testCases {
		actual := assignTasks(testCase.servers, testCase.tasks)
